    ...
    static var all: [OnboardingPageContent] {
        [
            ...
            OnboardingPageContent(
                ...
                body: String(localized: "iOS won't let apps read the clipboard in the background, so Déjà only saves at these three moments."),
                skipTitle: String(localized: "Skip"),
                artwork: .tray,
                rows: [
                    ...
                    Row(symbol: "square.and.arrow.up",
                        ...
                        detail: String(localized: "“Save to Déjà” in any app")),
