...
private struct FolderSyncSections: View {
    ...
    var body: some View {
        Section {
            ...
            Group {
                if SyncService.isAvailable {
                    Text("By default your clipboard history and Pinboards sync between your Macs through iCloud Drive (iCloud Drive/Paster/). The data only ever passes through your own iCloud — Copyo never touches a third-party server. Deletions are not propagated across devices.")
